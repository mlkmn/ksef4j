...
/**
 * Pure-function mapper translating the English-named {@link Invoice} DTO to a JAXB-generated FA(3)
 * {@link Faktura} tree. v0.1 allowlist only: domestic VAT invoice, one seller and one buyer (NIP +
...
public final class InvoiceMapper {
  ...
  private static BigDecimal vatOf(BigDecimal net, int percent) {
    return net.multiply(BigDecimal.valueOf(percent)).divide(HUNDRED, SCALE, RM);
  }
