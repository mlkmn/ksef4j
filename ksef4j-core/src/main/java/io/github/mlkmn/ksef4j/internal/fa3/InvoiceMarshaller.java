...
/**
 * Marshals a {@link Faktura} JAXB tree into UTF-8 XML bytes. Thread-safe:
 * {@link JAXBContext} is built once in the constructor and reused;
 * {@link Marshaller} instances are short-lived and per-call, per the JAXB spec.
 */
