...
/**
 * Internal: per-session symmetric material (AES-256 key + 128-bit IV). Wraps
 * the key with RSA-OAEP for the open-session call and AES-256-CBC encrypts each
 * invoice. Create via {@link #generate(SecureRandom)}.
 */
