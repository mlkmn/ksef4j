...
/**
 * The two KSeF v2 public-key certificate purposes, distinguished by the {@code usage}
 * field of {@code GET /security/public-key-certificates}. Same OAEP recipe, different keys.
 */
