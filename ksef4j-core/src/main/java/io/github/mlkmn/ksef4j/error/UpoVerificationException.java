...
/**
 * Raised when a received UPO fails verification - e.g. its document hash does not match the invoice
 * that was sent. Signals a receipt that must not be trusted as-is.
 */
