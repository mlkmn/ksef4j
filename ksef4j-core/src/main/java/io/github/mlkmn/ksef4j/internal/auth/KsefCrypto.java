...
/**
 * Internal: encrypts the KSeF challenge token under the environment public key, per the locked
 * RSA-OAEP-SHA-256 recipe (delegated to {@link KsefRsa}). Stateless.
 */
final class KsefCrypto {
  ...
  /**
   * Encrypts {@code token|timestampMs} with RSA/ECB/OAEPPadding (SHA-256, MGF1-SHA-256) and
