...
/**
 * Base type for all errors raised by ksef4j. All subclasses are unchecked
 * (extend {@link RuntimeException}); this base is sealed so the set of
 * failure modes is closed and adding a new one is a deliberate API change.
 */
