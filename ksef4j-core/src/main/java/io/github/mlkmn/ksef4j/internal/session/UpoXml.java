...
/**
 * Internal: extracts the invoice KSeF number and issue time from a UPO XML
 * document. Matches by element local name (namespace-tolerant). The element
 * names follow the UpoV4_3 schema (validated by the deferred live smoke test).
 */
final class UpoXml {
    ...
    record Parsed(String ksefReferenceNumber, Instant issuedAt, String documentHash, String invoiceNumber) {
    }
