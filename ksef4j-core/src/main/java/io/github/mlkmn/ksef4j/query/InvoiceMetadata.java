...
/**
 * Header-level facts about one invoice, as returned by a metadata query. Does not include line
 * items or the full FA(3) body; download the invoice by KSeF number for those.
 *
