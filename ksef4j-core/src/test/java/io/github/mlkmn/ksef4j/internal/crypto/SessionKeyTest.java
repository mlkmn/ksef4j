...
class SessionKeyTest {
  ...
  void encrypt_round_trips_with_same_key_and_iv() throws Exception {
    ...
    decrypt.init(
        Cipher.DECRYPT_MODE, new SecretKeySpec(FIXED_KEY, "AES"), new IvParameterSpec(FIXED_IV));
  ...
  void ciphertext_matches_independent_aes_cbc_pkcs7_encryption() throws Exception {
    ...
    reference.init(
        Cipher.ENCRYPT_MODE, new SecretKeySpec(FIXED_KEY, "AES"), new IvParameterSpec(FIXED_IV));
