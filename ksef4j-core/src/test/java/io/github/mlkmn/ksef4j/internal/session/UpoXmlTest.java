...
class UpoXmlTest {
    ...
    void extracts_ksef_number_and_issued_at() {
        byte[] xml = ("<upo:Potwierdzenie xmlns:upo=\"http://upo.schematy.mf.gov.pl/KSeF/v4-3\">"
                ...
                + "</upo:Potwierdzenie>").getBytes(StandardCharsets.UTF_8);
    ...
    void missing_element_throws_transport_exception() {
        byte[] xml = ("<upo:P xmlns:upo=\"urn:x\"><upo:Other>x</upo:Other></upo:P>")
    ...
    void parses_all_fields_from_a_real_upo() throws Exception {
        byte[] xml = Objects.requireNonNull(
                UpoXmlTest.class.getResourceAsStream("/upo/real-upo-v4-3.xml"),
                "fixture /upo/real-upo-v4-3.xml not found").readAllBytes();
