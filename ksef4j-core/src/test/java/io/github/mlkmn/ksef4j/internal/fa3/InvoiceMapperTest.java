...
class InvoiceMapperTest {
    ...
    void single_line_invoice_maps_seller_buyer_dates_and_one_line() {
        ...
        assertThat(f.getPodmiot2().getDaneIdentyfikacyjne().getNazwa()).isEqualTo("Customer Sp. z o.o.");
    ...
    void item_unit_overrides_default() {
        Invoice invoice = invoiceWithItem(
                new Item("Service", new BigDecimal("8"), new BigDecimal("100.00"), VatRate.VAT_23, "godzina", null));
    ...
    void item_blank_unit_falls_back_to_default() {
        Invoice invoice = invoiceWithItem(
                new Item("Service", new BigDecimal("8"), new BigDecimal("100.00"), VatRate.VAT_23, "   ", null));
    ...
    void item_pkwiu_emitted_when_present() {
        Invoice invoice = invoiceWithItem(
                new Item("Service", new BigDecimal("8"), new BigDecimal("100.00"), VatRate.VAT_23, null, "62.01.11.0"));
    ...
    void item_pkwiu_absent_when_null() {
        Invoice invoice = invoiceWithItem(
                new Item("Service", new BigDecimal("8"), new BigDecimal("100.00"), VatRate.VAT_23, null, null));
    ...
    private static Invoice invoiceWithItem(Item item) {
        ...
        return new Invoice(
                ...
                base.exchangeRate(),
                base.seller(), base.buyer(), List.of(item));
    }
}
