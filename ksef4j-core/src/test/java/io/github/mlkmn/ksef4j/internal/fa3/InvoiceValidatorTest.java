...
class InvoiceValidatorTest {
    ...
    void item_description_must_not_be_blank() {
        Invoice invoice = withSingleItem(new Item("", BigDecimal.ONE, new BigDecimal("10.00"), VatRate.VAT_23, null, null));
    ...
    void item_quantity_must_be_positive() {
        Invoice invoice = withSingleItem(new Item("Desc", BigDecimal.ZERO, new BigDecimal("10.00"), VatRate.VAT_23, null, null));
    ...
    void item_unit_price_must_be_non_negative() {
        Invoice invoice = withSingleItem(new Item("Desc", BigDecimal.ONE, new BigDecimal("-1.00"), VatRate.VAT_23, null, null));
    ...
    void item_unit_max_length_is_256() {
        Invoice invoice = withSingleItem(
                new Item("Desc", BigDecimal.ONE, new BigDecimal("10.00"), VatRate.VAT_23, "x".repeat(257), null));
    ...
    void item_pkwiu_max_length_is_50() {
        Invoice invoice = withSingleItem(
                new Item("Desc", BigDecimal.ONE, new BigDecimal("10.00"), VatRate.VAT_23, null, "9".repeat(51)));
    ...
    private static Invoice withCurrencyAndRate(String currency, BigDecimal rate) {
        ...
        return new Invoice(
                base.invoiceNumber(), base.issueDate(), base.saleDate(), currency, rate,
                base.seller(), base.buyer(), base.items());
    }

    private static Invoice invoiceWithSellerNip(String nip) {
        Invoice base = InvoiceFixtures.singleLineVat23();
        return new Invoice(
                base.invoiceNumber(), base.issueDate(), base.saleDate(), base.currency(),
                null,
    ...
    private static Invoice withInvoiceNumber(String number) {
        Invoice base = InvoiceFixtures.singleLineVat23();
        return new Invoice(
                number, base.issueDate(), base.saleDate(), base.currency(),
                null,
                base.seller(), base.buyer(), base.items()
        );
    }
