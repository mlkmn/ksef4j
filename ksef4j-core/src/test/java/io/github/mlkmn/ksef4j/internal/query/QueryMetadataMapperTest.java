...
class QueryMetadataMapperTest {
    ...
    void maps_wire_entry_to_public_metadata() {
        Responses.QueryMetadata.Entry entry = new Responses.QueryMetadata.Entry(
                "KSEF-1", "FV/1",
                "2026-01-10", "2026-01-10T09:30:00Z", null,
                ...
                new BigDecimal("100.00"), new BigDecimal("123.00"), new BigDecimal("23.00"), "PLN",
                "VAT",
    ...
    void unparseable_date_becomes_transport_exception() {
        Responses.QueryMetadata.Entry bad = new Responses.QueryMetadata.Entry(
                "KSEF-1", "FV/1", "not-a-date", null, null, null, null,
                null, null, null, "PLN", "VAT", null, "hash-1");
