...
class InvoiceMetadataPageTest {
    ...
    void next_offset_is_page_offset_plus_item_count() {
        InvoiceMetadataPage page = new InvoiceMetadataPage(
                List.of(meta("A"), meta("B"), meta("C")), true, false, 10, 100);
    ...
    private static InvoiceMetadata meta(String ksef) {
        return new InvoiceMetadata(ksef, "FV/1", null, null, null, null, null, null, null, null, null, null, null);
    }
}
