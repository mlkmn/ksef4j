...
class EnvironmentEndpointsTest {
  ...
  void test_environment_uses_api_test_base() {
    ...
    assertThat(e.challenge())
        .isEqualTo(URI.create("https://api-test.ksef.mf.gov.pl/v2/auth/challenge"));
  }
  ...
  void builds_all_paths_from_base() {
    ...
    assertThat(e.sendInvoice("S1"))
        .isEqualTo(URI.create("http://localhost:8080/sessions/online/S1/invoices"));
    assertThat(e.sessionStatus("S1")).isEqualTo(URI.create("http://localhost:8080/sessions/S1"));
    assertThat(e.closeSession("S1"))
        .isEqualTo(URI.create("http://localhost:8080/sessions/online/S1/close"));
  }
